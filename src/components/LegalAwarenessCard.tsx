    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-5 md:p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h2 className="text-2xl font-bold">Know Your Rights</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Deepfakes can constitute impersonation or fraud.</p>
                </div>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-600">
                    <h3 className="flex items-center gap-2 font-semibold text-lg mb-2 text-gray-800 dark:text-gray-200">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <a
                        ...
                        className="flex-1 group flex flex-col p-4 rounded-lg border border-gray-200 dark:border-gray-600 hover:border-blue-500 dark:hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-all cursor-pointer"
                    >
                        <div className="flex items-center justify-between mb-2">
                            <h4 className="font-semibold text-gray-800 dark:text-gray-200">File a Complaint</h4>
                    ...
                    {/* SECTION 3: HELPLINE */}
                    <div className="flex-1 flex flex-col p-4 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800">
                        ...
                        <div className="mt-auto">
                            <span className="text-2xl font-bold text-blue-600 dark:text-blue-400 tracking-wider">1930</span>
                            <span className="text-xs text-gray-400 ml-2">(National Helpline)</span>
                        </div>
                    </div>
                </div>
            </div>
